# Generated by Django 5.2.9 on 2026-02-18 08:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('catalogs', models.ManyToManyField(related_name='tool_catalogs', to='tool_picker.catalog')),
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='%(class)s_created', to=settings.AUTH_USER_MODEL)),
                ('modified_by', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='%(class)s_modified', to=settings.AUTH_USER_MODEL)),
                ('tool_owners', models.ManyToManyField(blank=True, related_name='tool_owners', to=settings.AUTH_USER_MODEL)),
                ('tool_sectors', models.ManyToManyField(blank=True, related_name='tool_sectors', to='tool_picker.sector')),
                ('tool_features', models.ManyToManyField(blank=True, related_name='tool_features', to='tool_picker.toolfeature')),
            ],
            options={
                'ordering': ['name'],
                'abstract': False,
        ...
        migrations.AddConstraint(
            model_name='question',
            constraint=models.UniqueConstraint(fields=('catalog', 'order'), name='unique_catalog_order'),
        ),
        migrations.AddConstraint(
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('tool', 'question'), name='unique_tool_question'),
        ),
        migrations.AddConstraint(
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('submission', 'rank'), name='unique_submission_rank'),
        ),
    ]
